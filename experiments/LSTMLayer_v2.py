...
class LSTMLayer_v2(MergeLayer):
    r"""
    LSTMLayer_v2(incoming, num_units,
    ...
    def __init__(self, incoming, num_units,
        ...
        super(LSTMLayer_v2, self).__init__(incomings, **kwargs)
    ...
    def get_hid_cell_for(self, inputs, **kwargs):
        """
        Compute this layer's hidden and cell states given a symbolic input variable
        Parameters
        ----------
        inputs : list of theano.TensorType
            `inputs[0]` should always be the symbolic input variable.  When
